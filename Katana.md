...
+ Bereichskontrolle – Vorkonfiguriertes Feld / [[RegEx (Reguläre Ausdrücke)]]  
+ Anpassbare Ausgabe – vorkonfigurierte Felder  
+ EINGABE – [[STDIN]], URL und LISTE  
+ AUSGABE – [[STDOUT]], FILE und JSON

## Examples

`katana -u subdomains_alive_subfinder.txt -d 5 -ps -pss waybackarchive,commoncrawl,alienvault -kf -jc -fx -ef woff,css,png,svg,jpg,woff2,jpeg,gif,svg -o katana.txt`

`katana -u https://example.com -jc -d 4 -o katana.txt`
