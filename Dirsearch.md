...
`dirsearch -u https://example.com -i 200,204,403,443 -x 500,502,501,429,503 -R 5 --random-agent -t 50 -F -o directory.txt -w /usr/share/wordlists/dirbuster/directory-list-1.0.txt -recursion`
